...
<div class="topnav">
  ...
  <a href="/18030012/login.php">Logut</a>
    ...
    <tbody>
      <?php
      $query = "SELECT * FROM tbl_utama ORDER BY id ASC";
      ...
      <td>
          <a href="delete_process_u.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data Vaksin Anda?')">Hapus</a> 
          </td>
      </tr>
      <?php
        $no++;
